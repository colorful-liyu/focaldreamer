...
class DMTetGeometry(torch.nn.Module):
    ...
    def initial_shape(self, FLAGS):
        ...
        #changed code position to ameliorate
        with torch.no_grad():
    ...
    def tick(self, glctx, target, lgt, opt_material, iteration, if_normal, guidance, mode, if_flip_the_normal, loss_fn):
        # ==============================================================================================
        ...
        text_embeddings = 'no stable diffusion'
        
        if mode == 'geometry_modeling':
            return self.geo_tick(iteration, guidance, buffers, text_embeddings, target, loss_fn, lgt)
        else: 
            return self.appear_tick(iteration, guidance, buffers, text_embeddings, target, loss_fn, lgt)

        
    def geo_tick(self, iteration, guidance, buffers, text_embeddings, target, loss_fn, lgt):
    ...
    def appear_tick(self, iteration, guidance, buffers, text_embeddings, target, loss_fn, lgt):
        # if iteration <= self.FLAGS.coarse_iter:
